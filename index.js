...
const port = process.env.PORT || 9090;
  ...
  console.log('Bot connected to whatsapp ✅')
    ...
    // YAHAN NAYA DESIGN ADD KIYA GAYA HAI (ORIGINAL/NON-BLUETICK)
    let up = `
*✦━━━━━━━━━━━━━━━✦*
   🤖  *QADEER-AI CONNECTED* *✦━━━━━━━━━━━━━━━✦*
...
`;
  ...
  // Use hardcoded ownerNumber here
...
// REMOVED OWNER REACT BLOCK AS REQUESTED
...
if (!isReact && config.CUSTOM_REACT === 'true') {
  ...
  //==========WORKTYPE (Corrected Logic)============ 
  // Block commands if not public mode AND not owner/creator
  // Public Mode: Everyone can use (No return)
