  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(
        config.MENU_IMAGE_URL || "https://files.catbox.moe/3tihge.jpg",
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            ...
            body: config.DESCRIPTION || "𝐐𝐀𝐃𝐄𝐄𝐑-𝐀𝐈 🤌💗",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/3tihge.jpg", // Static image URL
            sourceUrl: "https://wa.me/message/3XUP6XZN34PAN1",
